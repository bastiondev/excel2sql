...
This repository is a TypeScript library implementation of the Excel2Sql language for translating Excel workbooks to and from SQL queries. It works in both Node.js and browser environments.
